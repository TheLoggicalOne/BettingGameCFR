...
class StrategyFamilyForCfr:
    ...
    def __init__(self, game_family, initial_strategy=None):
        ...
        self.numpy_file_str = 'S' + '_' + self.game.name
        # np.savez('S' + '_' + str(self.iteration) +self.game.name, self.initial_strategy, self.cumulative_regret,
...
if __name__ == '__main__':
    ### Now Running
    # (2)
    # Time_Family_betSFFB_handSFFH_max2to21_it1e1_subF= max_hand_family_cfr_family_run_time(False,
    #                                                    iterations=10,
    #                                                    progress_bar=True)
    #(3)
    # Time_Family_betSFFB_handSFFH_max2to21_it1e1_subF = max_hand_family_cfr_family_run_time(True,
    #                                                                                        iterations=10,
    #                                                                                        progress_bar=True)

    #(4)
    Time_Family_betSFFB_handSFFH_max2to21_it5e1_subF = max_hand_family_cfr_family_run_time(False,
                                                                                           iterations=50,
                                                                                           progress_bar=True)
    #(5)
